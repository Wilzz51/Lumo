...
<div class="hs-dropdown relative inline-flex" data-hs-dropdown-options='{"placement": "bottom-end"}'>
    ...
    <div
        class="hs-dropdown-menu min-w-[10rem] z-[9999] bg-white shadow-md rounded-lg p-2 dark:bg-gray-800 dark:border dark:border-gray-700 hidden"
...
@else
    ...
    <div class="hs-dropdown relative inline-flex" data-hs-dropdown-placement="bottom-right">
        ...
        <div
            class="hs-dropdown-menu transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden min-w-[15rem] z-[9999] bg-white shadow-md rounded-lg p-2 dark:bg-gray-800 dark:border dark:border-gray-700"
            aria-labelledby="hs-dropdown-with-header">
